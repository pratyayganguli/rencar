	...
	<body>
		<div class = "row row-md-6 justify-content-center mt-4">
			<div class = "col col-sm-4 mt-4">
				...
				<a class = "btn btn-secondary mb-3" href = "view-manufacturers">View manufacturers <i class="bi bi-eye-fill"></i></a>
			
				<form class = "card card-light" method = "post" action = "create-manufacturer">
  					<div class = "card-body">
  						<h5 class = "text-dark mb-4 font-weight-bold">Add new car manufacturer</h5>
